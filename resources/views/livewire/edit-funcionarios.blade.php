                ...
                <section>
                    ...
                    <form method="get" class="mt-6 space-y-6" wire:submit.prevent="verificar">
                        ...
                        <div class="flex items-center gap-4">
                            <button type="submit" class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">Editar Funcionário</button>
                        </div>
                    </form>
